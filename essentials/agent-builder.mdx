...
<Columns cols={2}>
  <Card
    title="Review Tools + Actions"
    icon="wrench"
    href="/product/tools-and-actions"
    cta="Learn more"
    arrow="true"
  >
  ...
  <Card
    title="Build, Edit + Test Actions"
    icon="blocks"
    href="/product/action-builder"
    cta="Learn more"
    arrow="true"
  >
  ...
  <Card
    title="Design + Deploy End User Experience"
    icon="sparkles"
    href="/product/agent-experience"
    cta="Learn more"
    arrow="true"
  >
  ...
  <Card
    title="Review and Debug Agent Performance"
    icon="chart-no-axes-combined"
    href="/product/agent-observability"
    cta="Learn more"
    arrow="true"
  >
