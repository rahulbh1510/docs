...
<Frame>
  ![The Data Store showing table cards for close\_checklist, close\_reconciliations, general\_ledger, tax\_returns, invoices, and clients, each with a column count, row count, and last-updated stamp](/images/acct-data-store-tables.png)
</Frame>
...
<Frame>
  ![The close\_checklist table detail on the Data tab, showing rows with SOURCE\_ID, COMPANY, PERIOD, FOLDER, and DESCRIPTION columns, and a toolbar with Filter, Refresh, Import CSV, and Insert row](/images/acct-data-store-data.png)
</Frame>
...
<Frame>
  ![The close\_checklist Schema tab listing columns such as source\_id, company, period, and preparer\_due\_date with types text, numeric, date, and timestamp](/images/acct-data-store-schema.png)
</Frame>
