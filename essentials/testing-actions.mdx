...
description: "Learn the two ways you can test Actions - either in the Agent Builder interface or directly in your product via the Prompt Playground. "
icon: "flask"
---
...
You can watch the quick video walkthrough below to see how to Test actions in the Agent Builder or read through the notes below.

Just head into the **Action Details page**, and look over to the **Test Action panel** on the right.

![Testing-Action-1](https://asset.adopt.ai/web/docs/testing-actions-1.png)
...
Here's a quick video walkthough.

<iframe src="https://fast.wistia.net/embed/iframe/5vag3i2a7o?autoplay=0&seo=false&videoFoam=true" title="Wistia video player" allow="fullscreen" allowfullscreen frameborder="0" scrolling="no" width="100%" height="500" />
...
2. **Don’t have the Chrome extension yet? No problem.**
   ...
   ![Test-Action-1](https://asset.adopt.ai/web/docs/testing-actions-2.png)
3. **Input your Test URL**
   ...
   You can find this URL under [**Playground Profiles**](/essentials/playground-profiles) in your **Settings**.
