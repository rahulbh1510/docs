...
<video controls className="w-full aspect-video rounded-xl" src="https://asset.adopt.ai/web/videos/initial-setup.mp4" />
...
**And That's it.** Two steps, minimal effort on your end, maximum transformation for your users.
