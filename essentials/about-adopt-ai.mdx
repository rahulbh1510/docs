...
This is handled by our proprietary system Zero Shot Action Generation (ZACTION), which builds composable, testable actions designed for how users actually speak and work.
