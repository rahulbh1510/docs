...
<Frame>
  ![A prepared output open for review — the agent's narrative and an "Action needed" card in the centre, the workstream's files on the left, and a Workflow panel on the right showing each step's status](/images/acct-app-conversation-hitl.png)
</Frame>
