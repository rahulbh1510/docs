...
<Frame>
  ![The Workstreams page with a list of workstreams like XYZ Corp, Gamma Inc, and Delta Inc on the left, each showing a member count, and a member access list for the selected workstream on the right](/images/acct-workstreams.png)
</Frame>
