...
<Frame>
  ![The Pipelines library showing cards for R&D Tax Credit, Account Recon, Meridian Account Reconciliation, and Flux Report Demo, each with a status, source, schedule, and workstream](/images/acct-pipelines-library.png)
</Frame>
...
<Frame>
  ![The Create Pipeline builder on the Source step, showing the step indicator Source, Workstreams, Schedule, Describe, with fields for Pipeline Name, Skills, Agent, and a Source connector picker](/images/acct-pipelines-builder.png)
</Frame>
