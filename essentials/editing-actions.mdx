...
description: "Explore how to fine-tune an Action’s logic by modifying its instruction steps. You’ll learn about step types, editing in natural language or JSON, and how to adapt behavior to fit your application."
icon: "pencil"
---
