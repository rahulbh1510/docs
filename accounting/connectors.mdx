...
<Frame>
  ![The Connectors gallery showing a grid of integration tiles including NetSuite, Sage Intacct, SAP, GST Portal, and Plaid, with filter chips for Popular, All, Connected, and Available](/images/acct-connectors-gallery.png)
</Frame>
...
<Tabs>
  <Tab title="Custom Integration">
    ...
    <Frame>
      ![The Create New MCP Integration form in Custom Integration mode, showing fields for Integration Name, Description, Categories, and Integration Icon](/images/acct-connectors-custom-mcp.png)
    </Frame>
  </Tab>
  <Tab title="Remote Connection">
    ...
    <Frame>
      ![The Create New MCP Integration form in Remote Connection mode, showing MCP Link, Connection Type, Authentication Type set to Custom Headers, and a Headers key-value section](/images/acct-connectors-remote-mcp.png)
    </Frame>
  </Tab>
</Tabs>
...
<Frame>
  ![The API Discovery page showing job statistics for Total, Running, Completed, and Failed jobs, with a table of discovery jobs listing mode, timestamps, and APIs found](/images/acct-connectors-api-discovery.png)
</Frame>
