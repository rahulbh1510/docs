...
You can watch the video below for a complete walkthrough of the Actions tab inside the Agent Builder platform, or keep reading for a step-by-step breakdown.
...
| :---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Type**          | The name of the action the agent can perform. This is usually phrased in natural language for easy scanning—like _“Display all pending tasks”_.                                                                                                         |
| **Tools**         | The category of action based on intent: <br />• <br />`Assist` – Uses KB content to answer or guide users <br />• <br />`Navigation` – Opens a page or route <br />• <br />`Create`, `Fetch`, `Update`, `Delete` – Standard CRUD actions linked to APIs |
| **Topics**        | The underlying components (APIs, KB pages, or app routes) that power the action. Actions often pull from multiple tools to execute a complete flow.                                                                                                     |
| **Last Modified** | High-level product areas or workflows—like _“Spend Management”_ or _“Access Management.”_ These are automatically derived from your Knowledge Base and help categorize where each action belongs.                                                       |
| **Status**        | The most recent date the action was edited or updated. Helpful for version tracking.                                                                                                                                                                    |
|                   | A toggle to **Publish** or **Un-publish** an action. Only published actions are available to the end users to use. Keep them unpublished until fully reviewed.                                                                                          |
...
Now that you've got the foundation down, you might want to dive into particular use cases.

Head over to our **Use Cases** section to learn how to create and edit actions, test them before going live, monitor agent performance, and all the other ways you can fine-tune your agentic experience.