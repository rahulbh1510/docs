...
<Columns cols={2}>
  ...
  <Card title="Adopt Harness for Accounting & Tax" icon="file-invoice-dollar" href="/accounting" cta="Explore Accounting & Tax" arrow>
    The verticalised platform for accounting and tax — agents that run close, reconciliation, tax, and advisory workflows, with a professional reviewing every result.
  </Card>
</Columns>
