...
description: "Overview of the Adopt dashboard for monitoring and reviewing your Agent's Performance"
icon: "gauge"
---
...
![Dashboard-1](https://asset.adopt.ai/web/docs/dashboard-1.png)

![Screenshot2025 08 07at12 08 14PM Pn](/images/Screenshot2025-08-07at12.08.14PM.png)
...
All the metrics you see on the Dashboard are powered by the [**Logs**](/essentials/logs) - a complete record of every agent interaction. In the next section, we’ll explore how you can use the Logs to view, trace, and debug each step behind the scenes.