...
icon: "gamepad"
description: "Test your agent safely in staging, production, or demo environments using configurable in-app Playground Profiles."
---
...
![Playground-Profile-1](https://asset.adopt.ai/web/docs/playground-profiles-1.png)
...
It’s what powers in-app [testing via the Chrome extension](/essentials/testing-actions) and ensures the agent has the right access and context to operate inside your UI.

You can manage your Playground Profiles from: **Profile → Settings → Playground Profiles** (left sidebar tab)

During [initial setup](/essentials/initial-setup), we automatically create your first Playground Profile using the **demo account access** you provided.
...
<img
  src="https://asset.adopt.ai/web/docs/playground-profiles-2.png"
  alt="Playground-Profile-1"
  style={{ width:"63%" }}
/>
