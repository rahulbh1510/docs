...
description: "We help software companies turn their apps into intelligent AI agents that understand user intent and take action instantly—with zero engineering lift to get started."
---
...
<aside>
  <img src="/icons/target_blue.svg" alt="/icons/target_blue.svg" width="40px" />
...
### **Here's how we build Tools and Action automatically →**
...
This automated API Discovery process is managed by our proprietary Zero-Shot API Ingestion system; aka [ZAPI.](https://www.notion.so/Zero-Shot-API-Generation-ZAPI-239177d21d0480639c37de5e1ac493ab?pvs=21)
...
This is handled by our proprietary system Zero Shot Action Generation [\*\*(ZACTION)](https://www.notion.so/Zero-Shot-Action-Generation-ZACTION-239177d21d0480a19933cde97bccfa5e?pvs=21), which\*\* builds composable, testable actions designed for how users actually speak and work.
