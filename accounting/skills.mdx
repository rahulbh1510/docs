...
<Frame>
  ![The Skills library showing a grid of skill cards including 409a-esop-valuation-builder, accounting-tax-research, adopt-flux-report, close-reconcile, and client-intake, each marked as a Custom skill](/images/acct-skills-library.png)
</Frame>
...
<Frame>
  ![The adopt-flux-report skill detail page showing the SKILL.md instruction with a Preview and Markdown toggle, a Files panel listing templates, reference docs, and scripts, and a Test in playground button](/images/acct-skills-detail.png)
</Frame>
